...
The module created within this tutorial can be found [here](https://github.com/PrestaShop/example-modules)
...
You can find full implementation [here](https://github.com/PrestaShop/example-modules) which uses CQRS pattern to toggle the reviewer state. [More about it here]({{< relref "/8/development/architecture/domain/cqrs" >}}).
{{% /notice %}}
...
You can find full implementation [here](https://github.com/PrestaShop/example-modules) which uses CQRS pattern to get reviewer state. [More about it here]({{< relref "/8/development/architecture/domain/cqrs" >}}).
{{% /notice %}}
...
You can find full implementation [here](https://github.com/PrestaShop/example-modules) which uses CQRS pattern to create or update reviewer state. [More about it here]({{< relref "/8/development/architecture/domain/cqrs" >}}).
{{% /notice %}}
