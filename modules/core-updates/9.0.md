...
The following hooks have been removed due to the unavailability of the legacy product page. If your modules rely on any of these hooks, you will need to update your implementation to be compatible with the new product page and controller structure.
